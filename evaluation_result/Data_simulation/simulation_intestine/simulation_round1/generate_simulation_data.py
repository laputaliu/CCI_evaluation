...
if __name__ == '__main__':
    ...
    # imput data files #
    ####################
    st_pos_path = '/fs/home/liuzhaoyang/project/cci_evaluation/human_intestinal/data/processed/intestinal_st_coord.tsv'
    st_meta_path = '/fs/home/liuzhaoyang/project/cci_evaluation/human_intestinal/data/processed/intestinal_st_predict_celltype.tsv'

    sc_count_path = '/fs/home/liuzhaoyang/project/cci_evaluation/human_intestinal/data/processed/intestinal_sc_count.tsv'
    sc_meta_path = '/fs/home/liuzhaoyang/project/cci_evaluation/human_intestinal/data/processed/intestinal_sc_meta.tsv'
    ...
    simulate_target_cts = ['Myofibroblast_Mesothelium','Neural','Endothelium','Muscle']
    ...
    if tf_flag:
        ...
        rec_tf_df = pd.read_csv('/fs/home/liuzhaoyang/biosoft/cellcall-master/inst/extdata/new_ligand_receptor_TFs.txt', sep='\t')
        tf_target_df = pd.read_csv('/fs/home/liuzhaoyang/biosoft/cellcall-master/inst/extdata/tf_target.txt', sep='\t')
    ...
    # simulate parameters
    tmp_output_df = pd.DataFrame([add_sigma, add_fc, nip_per_ctp, target_ip_cell_per, min_cells, min_cell_per_spot, max_cell_per_spot, r_seed],
                                index = ['add_sigma', 'add_fc', 'nip_per_ctp', 'target_ip_cell_per', 'min_cells', 'min_cell_per_spot', 'max_cell_per_spot', 'r_seed'],
                                columns = ['value'])
